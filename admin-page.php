     ...
     <div id="container">
       ...
       <div class="back-image">
         <div class="faculty-btn">
          <a href="faculty-data.php"><img src="images/faculty-btn.png" alt="faculty button" class="btn"></a>
         </div>
         <div class="student-btn">
           <a href="student-data.php"><img src="images/student-btn.png" alt="student button" class="btn"></a>
         </div>
       </div>
     </div>
     <?php endif ?>
